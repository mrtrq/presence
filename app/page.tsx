    ...
    <>
      ...
      <Section id="projects" title="Websites" kicker="Projects">
        ...
        <div className="grid md:grid-cols-3 gap-6">
          ...
          {/* Nitip Doa */}
          <WebsiteCard topic="Initiative" title="Nitip Doa" desc="Send your du'a, someone will read it at Mecca / Medina" href="https://nitipdoa.com/" image="/nitipdoa.png" imageAlt="Website screenshot"></WebsiteCard>
